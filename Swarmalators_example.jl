...
push!(forces, Force("Translatational Swarmalator force", "pair", Dict("N"=>N, "J"=>0.1), contribute_swarm_pos_force! ))
push!(forces, Force("Angular Swarmalator force", "pair", Dict("N"=>N, "K"=>1), contribute_swarm_angular_force! ))
...
#%%
states = Euler_integrator(system, 0.1, 1000, 1, 1, plot_Swarmalators!);
