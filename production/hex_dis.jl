...
function relaxation_step(save_folder_path; Tsave=1000, Tplot=10)
...
function self_aligning_step(rx_step,J,v0, Dr, seed,save_folder_path; Tsave=1000, Tplot=10)
...
function relax_again_step(sa_step, save_folder_path; Tsave=1000, Tplot=100)
...
save_folder_path = "/Volumes/T7_Shield/sa/survey/hex_disordered/phi_1_3/Nlin_20/simdata/"


rx_result= relaxation_step(save_folder_path)
sa_result=self_aligning_step(rx_result,.1,0.0001, 0.001,100, save_folder_path);
