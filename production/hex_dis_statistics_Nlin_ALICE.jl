...
include(joinpath("/data1/kammeraatsc1/JAMs/src","Engine.jl"))


include(joinpath("/data1/kammeraatsc1/JAMs/io","InitialPositionGenerators.jl"))
...
base_path = "/data1/kammeraatsc1/sa/statistics/"

Drs = [0.01, 0.1] 
Js=[0.1, 0.01]
Nlins = [5, 10, 20, 30, 40, 50, 60]
