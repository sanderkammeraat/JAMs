...
@everywhere include(joinpath("/data1/kammeraatsc1/JAMs/src","Engine.jl"))

@everywhere include(joinpath("/data1/kammeraatsc1/JAMs/io","InitialPositionGenerators.jl"))
...
@everywhere function relaxation_step(save_folder_path; Tsave=nothing, Tplot=nothing, N=2000)
...
#13 Js
@everywhere Js=[0.0, 0.001, 0.01, 0.02, 0.04, 0.08, 0.10, 0.12, 0.16, 0.2, 0.4, 0.8, 1]#[0.1, 0.01]
@everywhere v0s = [0.01]#[0.001, 0.003, 0.01, 0.03,  0.10, 0.12, 0.15]
