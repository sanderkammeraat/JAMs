...
@everywhere function relaxation_step(save_folder_path; Tsave=nothing, Tplot=nothing, Nlin=20)
...
@everywhere base_path = "/data1/kammeraatsc1/sa/statistics"

@everywhere Drs = [ 0.01, 0.1] 
@everywhere Js=[0.1, 0.01]
@everywhere v0s = [0.001, 0.003, 0.01, 0.03,  0.10, 0.12, 0.15]
