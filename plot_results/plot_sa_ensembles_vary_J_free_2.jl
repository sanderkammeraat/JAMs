...
base_folder = "/Volumes/T7_Shield/sa/statistics/free/phi_1.3/N_2000"   #"/Users/kammeraat/mounting/data2_kammeraat/sa/statistics/hex_disordered/phi_1.3/Nlin_20"
...
for e in ensemble_files
    ...
    scatterlines!(ax, e["vrms_r"]["r_bin_centers"], e["vrms_r"]["vrms_r"]/e["v0"], colorrange = (0, 13 ) , color=color_dict[e["J"]], label="J = $(e["J"])", colormap=:turbo)
    end
...
for e in ensemble_files
    ...
    scatterlines!(ax,det , e["auto_p"]["Cavg"], colorrange = (0, 13 ) , color=color_dict[e["J"]], label="J = $(e["J"])", colormap=:turbo)
...
for e in ensemble_files
    ...
    scatterlines!(ax,det , e["auto_v"]["Cavg"], colorrange = (0, 13 ) , color=color_dict[e["J"]], label="J = $(e["J"])", colormap=:turbo)
