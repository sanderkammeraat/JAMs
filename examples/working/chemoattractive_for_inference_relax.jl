...
function simulation(save_path)
    ...
    field_forces =(field_propulsion_distr_force(1,1000,1.,1.5/0.3*2,0.3), self_align_with_∇C_force(1,5), grad_field_propulsion_force(1,0.,-15))
    ...
    # [field_propulsion_3d_force(1,1e-2,0.01)] #0.3
