...
function simulation()
    ...
    pair_forces = (soft_disk_force(1,1),pairAN_force(1,1.2,0.1,0.1,true), pair_nematic_alignment_force(1,2.5,.1))
    ...
    sim = Euler_integrator(system,0.05, 1e5, Tplot=2,fps=120,plot_functions=(plot_disks_nematic_orientation!, plot_directors!, plot_velocity_vectors!), plotdim=2); 
    return sim;
