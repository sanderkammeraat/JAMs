...
function simulation(save_path)
    ...
    R = 1.
    pair_forces =(exp_repulsion_force(1, 5. *R,0.45),)
    #type,  consumption, cmid, v0max, σ in Lorentzian
    #asymmetric_field_propulsion_distr_force(1,2000,log10(0.2),4.5*20,0.261)
    
    field_forces =(field_propulsion_distr_force(1,2000,log10(0.2),4.5/5*1.5,0.261), self_align_with_∇C_force(1,5), grad_field_propulsion_force(1,0.,-10))
