...
function simulation(save_path)
    ...
    field_forces =(field_propulsion_distr_force(1,5,log10(2),4.5/5*2.5,0.261), self_align_with_∇C_force(1,3), grad_field_propulsion_force(1,0.,-10))
...
sim = simulation(joinpath(homedir(),"surfdrive","ActivePolygonClusters","simulations","for_inference_v21_exp_rep","phi_0p01","simdata"))
