...
function simulation(save_path)
    ...
    pair_forces =(exp_repulsion_force(1, 5.,0.45),)
    #type,  consumption, cmid, v0max, σ in Lorentzian
    field_forces =(field_propulsion_distr_force(1,5e2,1.,1.5/0.3,0.3), self_align_with_∇C_force(1,5), grad_field_propulsion_force(1,0.,-8))
...
sim = simulation(joinpath(homedir(),"surfdrive","ActivePolygonClusters","simulations","for_inference_v11_exp_rep","phi_0p01","simdata"))
