...
function simulation(soft_disk_no_overlap_result)
    ...
    pair_forces =[exp_shape_disk_force(1,1)]#[soft_shape_disk_force(1,0.1)]
    ...
    #Use plot_disks! for nice visualss
    #Use plot_points! for fast plotting
    sim = Euler_integrator(system,0.01, 1e4, Tplot=50,fps=120,plot_functions=(plot_shape_disks_orientation!,plot_disks_orientation!,plot_directors!), plotdim=2); 
    return sim;
