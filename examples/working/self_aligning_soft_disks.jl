...
function simulation()
    ...
    pair_forces = (soft_disk_force(1,0.4),)
    ...
    sim = Euler_integrator(system,0.05, 200, Tplot=10,fps=60,plot_functions=(plot_disks_orientation!, plot_directors!, plot_velocity_vectors!), plotdim=2); 
    return sim;
