...
# base_folder = "/Volumes/T7_Shield/sa/statistics/free/phi_1.3/N_2000/simdata/"

# rp, sp, ap = auto_analysis_dir(base_folder, "sa_raw_data.h5"; support_raw_data_file_name_pattern = "ra_raw_data.h5")

# custom_analysis_function = correct_vrms_analysis!
...
#base_folder = "/Volumes/T7_Shield/sa/statistics/free/phi_1.3/N_2000/analysis/"# "/Volumes/T7_Shield/sa/statistics/hex_disordered/phi_1.3/Nlin_20/analysis/"

base_folder = "/Volumes/T7_Shield/sa/statistics/hex_disordered/phi_1.3/fa_complete/analysis/"
...
run_sequential_ensemble(ef, sf, sa_vrms_ensemble!, append=true)
